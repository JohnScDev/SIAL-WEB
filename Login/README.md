...
- `sial-login.js`: carrusel accesible, pausa/reanudar, tema claro/oscuro, toggle de contrasena, OTP y loading de demostracion.
...
- Toggle claro/oscuro conectado a `shared/sial-core.js`, persistente con `sial-theme`.
