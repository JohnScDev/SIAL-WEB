...
- `gestion-categorias-licencia.html`: gestion de licencias con listado prioritario y formulario corto embebido.
...
- `gestion-tipos-vehiculo.html`: gestion de tipos de vehiculos con formulario corto embebido.
- `gestion-tipos-empresa.html`: archivo fisico conservado en esta carpeta; funcionalmente se expone en el modulo Empresa.
- `relacion-empresa-tipo.html`: archivo fisico conservado en esta carpeta; funcionalmente se expone en el modulo Empresa.
...
- Gestion de licencias: maestra corta con listado maestro como prioridad y formulario embebido dentro de la card de gestion.
...
- Tipos de vehiculos: maestra corta con formulario embebido para nombre unico en mayusculas y activar/inactivar; el codigo autoincremental se conserva en el listado.
