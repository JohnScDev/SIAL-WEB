...
- `503.html`: servicio o modulo en mantenimiento temporal.
...
Las paginas dedicadas cubren errores de navegacion, acceso completo o mantenimiento global. Para errores dentro de una tabla, consulta o modulo, se debe usar el componente compartido `error-state` definido en `shared/sial-core.css`.
